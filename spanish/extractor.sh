...
csvcut -c 3,4 spanish_pets.csv | sed 's/\[PET_BOUNDARY\]//g' > spanish_pets_cleaned.csv

if [ $? -eq 0 ]; then
    echo "The cleaned dataset has been successfully created: spanish_pets_cleaned.csv"
else
